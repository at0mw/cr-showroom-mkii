...
const cameraInputsInstanceModule = (id, elementIds) => {
    'use strict';    

    // BEGIN::CHANGEAREA - your initialization code for each instance of widget goes here  
    // console.log(`cameraInputs-widget cameraInputsInstanceModule("${id}", [${elementIds}])`);
    ...
    const cleanup = () => {
        // console.log(`cameraInputs-widget cameraInputsInstanceModule cleanup("${id}")`);
    };
...
const cameraInputsModule = (() => {
     ...
     */
    function onInit() {
       serviceModule.addEmulatorScenarioNoControlSystem("./app/project/components/widgets/camera-inputs/camera-inputs-emulator.json");
