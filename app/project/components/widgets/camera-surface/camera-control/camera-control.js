...
const cameraControlModule = (() => {
     ...
     */
    function onInit() {
       serviceModule.addEmulatorScenarioNoControlSystem("./app/project/components/widgets/camera-control/camera-control-emulator.json");
       // Uncomment the below line and comment the above to load the emulator all the time.
       // serviceModule.addEmulatorScenario("./app/project/components/widgets/camera-control/camera-control-emulator.json");
    }
     ...
     */
    CrComLib.subscribeState('o', 'ch5-template:camera-control-widget', (value) => {
