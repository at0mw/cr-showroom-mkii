...
const settingsLogInstanceModule = (id, elementIds) => {
    ...
    // console.log(`settingsLog-widget settingsLogInstanceModule("${id}", [${elementIds}])`);
...
const settingsLogModule = (() => {
     ...
     */
    function onInit() {
       serviceModule.addEmulatorScenarioNoControlSystem("./app/project/components/widgets/settings-log/settings-log-emulator.json");
       // Uncomment the below line and comment the above to load the emulator all the time.
       // serviceModule.addEmulatorScenario("./app/project/components/widgets/settings-log/settings-log-emulator.json");
    }
