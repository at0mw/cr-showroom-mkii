...
const airMediaControlInstanceModule = (id, elementIds) => {
    ...
    // console.log(`airMediaControl-widget airMediaControlInstanceModule("${id}", [${elementIds}])`);
...
const airMediaControlModule = (() => {
     ...
     */
    function onInit() {
       serviceModule.addEmulatorScenarioNoControlSystem("./app/project/components/widgets/air-media-control/air-media-control-emulator.json");
       // Uncomment the below line and comment the above to load the emulator all the time.
       // serviceModule.addEmulatorScenario("./app/project/components/widgets/air-media-control/air-media-control-emulator.json");
    }
